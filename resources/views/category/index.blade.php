                            ...
                            @foreach ($category as $item)
                                <tr class="border-2 border-neutral-200 dark:border-white/10">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 flex">
                                        <a href="{{ route('categories.edit', ['category' => $item->slug]) }}" class="text-blue-500 dark:text-gray-400">Edit</a>
                                        <form action="{{ route('categories.destroy', ['category' => $item->slug]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
