            ...
            <div class="grid grid-cols-7 w-full pb-6 border-b border-gray-100">
                ...
                <div
                    ...
                    <div class="flex flex-col min-[500px]:flex-row min-[500px]:items-center justify-between">
                        <div class="">
                            <h5 class="font-manrope font-semibold text-2xl leading-9 text-black mb-6">{{ $item->name }}
                            </h5>
            ...
            <div class="flex items-center justify-center sm:justify-end w-full my-6">
                <div class=" w-full">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <p class="font-semibold text-xl leading-8 text-gray-900">Rs:{{ $item->order->order_total->subtotal }}</p>
                    </div>
                    <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex items-center justify-between py-6 border-y border-gray-100">
                        ...
                        <p class="font-manrope font-bold text-2xl leading-9 text-indigo-600">Rs: {{ $item->order->order_total->total }}</p>
                    </div>
                </div>
            </div>
            <div class="data ">
