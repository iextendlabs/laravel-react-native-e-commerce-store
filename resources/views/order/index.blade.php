                            ...
                            @if ($orderProduct->count() > 0)
                                @foreach ($orderProduct as $item)
                                    <tr class="border-2 border-neutral-200 dark:border-white/10">
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4 font-medium"><img src="{{ $item->product->image }}" width="50px" height="50px" alt=""></td>
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4">{{ $item->order->status }}</td>
