<x-app-layout>
    ...
    <div class="mx-auto block max-w-lg rounded-lg bg-white p-6 shadow-4 dark:bg-surface-dark mt-20">
        ...
        <form action="{{ route('your.profile.update', $customer->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-4">
                ...
                <input
                    ...
                    id="name" type="text" name="name" value="{{ $customer->name }}" placeholder="name" readonly>
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="username">
                    First Name
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="email" type="text" name="email" value="{{ $customer->email }}" placeholder="name" readonly>
            </div>
